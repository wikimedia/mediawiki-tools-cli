...
test_command_success "./bin/mw docker --context test-${TEST_TIMESTAMP}-just-core mediawiki get-code --no-interaction --core --shallow --use-github"
test_command_success "cat ${TEST_DIR}/index.php"
test_command "ls -lahrt ${TEST_DIR}/extensions | grep drwx | wc -l" "2"
test_command "ls -lahrt ${TEST_DIR}/skins | grep drwx | wc -l" "2"
...
test_command_success "./bin/mw docker --context test-${TEST_TIMESTAMP}-core-plus mediawiki get-code --no-interaction --core --skin Vector --skin Timeless --extension Nuke --extension Cognate --shallow"
test_command_success "cat ${TEST_DIR}/index.php"
test_command "ls -lahrt ${TEST_DIR}/extensions | grep drwx | wc -l" "4"
test_command "ls -lahrt ${TEST_DIR}/extensions" "Nuke"
test_command "ls -lahrt ${TEST_DIR}/extensions" "Cognate"
test_command "ls -lahrt ${TEST_DIR}/skins | grep drwx | wc -l" "4"
